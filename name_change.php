...
<div class="container">
    <header data-am-widget="header" class="am-header am-header-default my-header">
        ...
        <h1 class="am-header-title">
            <a href="name_change.php" class="">改昵称</a>
        </h1>
    ...
    <div class="cart-panel">
        ...
        <br></br>
        <form class="am-form" action="name_change.php?act=chk" method="post">
            <div class="am-form-group am-form-icon">
                <i class="am-icon-user" style="color:#329cd9"></i>
                <input name="user_name" type="text" class="am-form-field  my-radius" placeholder="请输入新昵称">
            </div>
